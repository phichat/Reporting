...
namespace Reporting.Reports {
    ...
    public class PartsMovement : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Reporting.Reports.PartsMovement.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPartsMovement : Component, ICachedReport {
        
        public CachedPartsMovement() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PartsMovement rpt = new PartsMovement();
            rpt.Site = this.Site;
            return rpt;
        }
