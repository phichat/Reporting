...
namespace Reporting.Reports {
    ...
    public class CarsMovement : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Reporting.Reports.CarsMovement.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCarsMovement : Component, ICachedReport {
        
        public CachedCarsMovement() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CarsMovement rpt = new CarsMovement();
            rpt.Site = this.Site;
            return rpt;
        }
